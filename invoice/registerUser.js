...
var store_path = path.join(__dirname, 'hfc-key-store'); //to read 'hfc-key-store' path
...
Fabric_Client.newDefaultKeyValueStore({
    ...
    return fabric_ca_client
        .enroll({
            enrollmentID: 'IBM',
            enrollmentSecret: secret_ibm
        })
        .then(() => {
            return fabric_ca_client
                .enroll({
                    enrollmentID: 'Lotus',
                    enrollmentSecret: secret_lotus
                })
                .then(() => {
                    return fabric_ca_client
                        .enroll({
                            enrollmentID: 'UBP',
                            enrollmentSecret: secret_ubp
                        });
                })
        })
