...
// this initLedger function can initialialized output to display
...
// This function can add and post data into the network data
...
// default function for json format
...
// this function can get all data to display to dashboard
...
// this function can performed to check the goods received
...
// This funcrion can verifiy if supplier was paid or not
...
// this function can verify if the invoice has paid to bank
...
// This function can display specific users
